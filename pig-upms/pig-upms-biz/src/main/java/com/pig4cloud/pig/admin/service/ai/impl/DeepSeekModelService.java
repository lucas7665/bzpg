...
public class DeepSeekModelService implements AIModelService {
    ...
    @Value("${ai.deepseek.api.temperature}")
    private double temperature;
    
    @Value("${ai.deepseek.api.max_tokens}")
    private int maxTokens;
    
    @Value("${ai.deepseek.api.timeout}")
    private int timeout;
    
    @Value("${ai.deepseek.prompt.file}")
    private String promptFile;
    
    @Value("${ai.deepseek.use_mock_data:false}")
    ...
    public boolean supports(String modelName) {
        return "deepseek".equalsIgnoreCase(modelName);
    }
