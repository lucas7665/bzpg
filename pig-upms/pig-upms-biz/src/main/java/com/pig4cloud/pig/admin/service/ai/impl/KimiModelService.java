...
public class KimiModelService implements AIModelService {
    ...
    @Value("${ai.kimi.api.model}")
    private String model;
    
    @Value("${ai.kimi.api.temperature}")
    private double temperature;
    
    @Value("${ai.kimi.api.max_tokens}")
    private int maxTokens;
    
    @Value("${ai.kimi.api.timeout}")
    private int timeout;
    
    @Value("${ai.kimi.prompt.file}")
    private String promptFile;
    
    @Value("${ai.kimi.use_mock_data:false}")
    ...
    public boolean supports(String modelName) {
        return "kimi".equalsIgnoreCase(modelName);
    }
    ...
    private String callKimiApi(String prompt) {
        ...
        throw new RuntimeException("Kimi API返回格式异常");
    }
}
